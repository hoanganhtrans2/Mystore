...
export class FashionStyleComponent implements OnInit {
  ...
  images: FashionStyle[] =[
    ...
    { 
      ...
      text:'Break your denim addiction with stylish alternatives to your most trusted legwear'
    },
    { 
      img:'../../assets/fashionstyle/fashionstyle3.jpg', 
      title:'The Best Mens Separates Combinations',
      text:'Mix and match like a pro and get more from your tailoring rotation'
    },
    { 
